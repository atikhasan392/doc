...
| `<YOUR_GIT_NAME>`  | Your Git display name  |
| `<YOUR_GIT_EMAIL>` | Your Git email address |
...
## Step 9 — Configure Passwordless MySQL Root Access
...
## Step 11 — Install Apache and Connect PHP-FPM
